...
function SurveyHeader({ className }: { className?: string }) {
        ...
        <div className="flex items-center gap-4">
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Create surveys, collect responses
            </p>
          </div>
          <Badge className="bg-primary/10 text-primary border-0 font-medium text-xs px-2.5 py-1 gap-1">
