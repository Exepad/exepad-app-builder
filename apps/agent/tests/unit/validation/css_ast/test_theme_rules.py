...
/*
 * Complete M3 @theme palette. Required by the deploy step (all 30 tokens must
 * resolve) and enforced at write time by style.m3.palette_incomplete. Kept
 * pure-monochrome so every M3_CONTRAST_PAIRS pairing is 21:1 and this fixture
 * exercises structure rules without tripping the contrast rule.
 */
@theme {
