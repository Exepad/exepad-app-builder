...
import { Search, Bell, User } from "@exepad/sdk";
  ...
  <div className="flex flex-col gap-4 bg-surface text-on-surface">
    <header className="flex items-center justify-between">
      ...
      <div className="flex items-center gap-3">
        <button aria-label="Bell" type="button" className="rounded p-2">
          <Bell className="h-5 w-5" />
        </button>
        <button aria-label="User" type="button" className="rounded p-2">
